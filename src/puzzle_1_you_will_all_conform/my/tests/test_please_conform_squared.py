...
from please_conform_squared import SolutionPleaseConformSquared


class TestSolutionPleaseConformSquared(TestCase):
    def setUp(self) -> None:
        self.solution = SolutionPleaseConformSquared()
